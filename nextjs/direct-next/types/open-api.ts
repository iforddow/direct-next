...
export interface paths {
  ...
  "/items/pages_page_blocks": {
    /**
     * List Items
     * @description List the pages_page_blocks items.
     */
    get: operations["readItemsPagesPageBlocks"];
    /**
     * Create an Item
     * @description Create a new pages_page_blocks item.
     */
    post: operations["createItemsPagesPageBlocks"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing pages_page_blocks items.
     */
    delete: operations["deleteItemsPagesPageBlocks"];
    /**
     * Update Multiple Items
     * @description Update multiple pages_page_blocks items at the same time.
     */
    patch: operations["updateItemsPagesPageBlocks"];
  };
  "/items/pages_page_blocks/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single pages_page_blocks item by unique identifier.
     */
    get: operations["readSingleItemsPagesPageBlocks"];
    /**
     * Delete an Item
     * @description Delete an existing pages_page_blocks item.
     */
    delete: operations["deleteSingleItemsPagesPageBlocks"];
    /**
     * Update an Item
     * @description Update an existing pages_page_blocks item.
     */
    patch: operations["updateSingleItemsPagesPageBlocks"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsPages: {
      ...
      slug: string;
      seo?: unknown;
      parent_page?: string | components["schemas"]["ItemsPages"] | null;
      page_blocks?: ((number | components["schemas"]["ItemsPagesPageBlocks"])[]) | null;
    };
    ItemsHeroBlock: {
      /** Format: uuid */
      id: string;
    ...
    ItemsPagesPageBlocks: {
      ...
      item?: ((string | components["schemas"]["ItemsHeroBlock"])[]) | null;
      sort?: number | null;
...
export interface operations {
  ...
  readItemsPagesPageBlocks: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsPagesPageBlocks"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsPagesPageBlocks: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsPagesPageBlocks"][] | components["schemas"]["ItemsPagesPageBlocks"];
      };
    };
    responses: {
      /** @description Successful request */
   ...
   * @description Retrieve a single pages_page_blocks item by unique identifier.
   */
  readSingleItemsPagesPageBlocks: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing pages_page_blocks item.
   */
  deleteSingleItemsPagesPageBlocks: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing pages_page_blocks item.
   */
  updateSingleItemsPagesPageBlocks: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsPagesPageBlocks"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type Schema = {
  ...
  pages_page_blocks: components["schemas"]["ItemsPagesPageBlocks"][];
};
